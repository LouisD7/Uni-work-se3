...
class PART3_WordFrequencyAnalyserTest {
	...
	void testLeastPopularWord() {
		...
		assertEquals("title", an.getLeastPopularWord(), "Incorrect least popular word identified, words not stored in an ordered collection?");
	}
	...
	void testAllAnalysis() {
		...
		try {
			...
			assertEquals("author", an.getLeastPopularWord(), "Incorrect least popular word identified, words not stored in an ordered collection?");
			assertEquals(1, an.getLeastPopularWordCount(), "Incorrect count of the least popular word identified");
